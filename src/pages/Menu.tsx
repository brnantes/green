...
const Menu = () => {
  ...
  const { foodItems, drinkItems, otherItems, displayedItems } = useMemo(() => {
    // Arrays para classificar os itens
    let foods: typeof menuItems = [];
    let drinks: typeof menuItems = [];
    let others: typeof menuItems = [];
    
    // SOLUÇÃO SIMPLIFICADA: Considerar todos os itens como comida por padrão
    // exceto aqueles que são explicitamente bebidas
