...
const Hero = () => {
  ...
  const heroBackgroundUrl = getImageUrl('hero_background', '/lovable-uploads/a51d0bdb-8cb1-4dcb-80a0-90df1afb8b1b.png');

  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background com imagem gerenciável */}
      <div className="absolute inset-0">
        <img 
          src={heroBackgroundUrl}
          alt="Green Table Club" 
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-4 space-y-8 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mt-12 animate-fade-in" style={{ animationDelay: '1.2s' }}>
          <Dialog>
            <DialogTrigger asChild>
              <Button 
                variant="outline" 
                className="border-green-primary text-green-primary hover:bg-green-primary hover:text-green-black text-lg px-8 py-4 h-auto font-semibold transition-all duration-300 hover:scale-105"
              >
                Clube Online
              </Button>
            </DialogTrigger>
